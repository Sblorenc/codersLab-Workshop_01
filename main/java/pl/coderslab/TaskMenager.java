...
public class TaskMenager {
    public static void main(String[] args) {
        ...
        static String[] data () {
            String[] tabTask={""};
            int i = 0;
            File file = new File("src/main/resources/task.csv");
            try {
                Scanner scann = new Scanner(file);
                while (scann.hasNextLine()) {
                    String tekst = scann.nextLine();
                    tabTask = Arrays.copyOf(tabTask, tabTask.length + 1);
                    tabTask[i] = tekst;
                    i++;
                }
        ...
        public static void menu () {
            ...
            String choice = scann.nextLine().toLowerCase().trim();
            switch (choice) {
                case "add":
                    add(data());
                    break;
                ...
                case "exit":
                    ...
                    break;
                default:
                    System.out.println(ConsoleColors.RED + "Incorrect");
                    menu();
            }
        }
        ...
        public static void add (String [] str) {
            ...
            String isImportant = scanner3.nextLine();
            String finalTask = task+" "+date+" "+isImportant;
            Arrays.copyOf(str, str.length +1);
            str[str.length-1] = finalTask;
            ...
            System.out.println(ConsoleColors.BLUE_BOLD+ "Task added");
            menu();
    }
    //Remove
